...
var ZeegaPlayer = Backbone.View.extend({
	...
	initialize: function(container,apiplayer){
		...
		this.apiplayer=true;
		if(this.apiplayer) this.container=$('#'+container);
	...
	loadProjectById : function(projectId, onReady, onEnded,options){
		...
		this.model.on('sequences_loaded',function(){
			...
			_this.initialFrame=_this.currentFrame;
	...
	*****************************/
	...
	goToFrame : function( frame )
	{
		...
		if(!this.apiplayer) this.router.navigate('player/frame/'+ frame.id, {silent:true});
...
*/		
	...
	*****************************/
	...
	getFrameCount : function(){
		...
		if(this.currentSequence) return this.currentSequence.collection.length;
		else return 0;
	...
	*****************************/
	...
	getTemplate : function()
	{
		...
		if(!this.apiplayer)html+=		"<div id='citation' class='player-overlay'><ul class='clearfix'></ul></div>";
